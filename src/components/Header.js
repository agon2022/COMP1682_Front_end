      ...
      <header className="">
        <nav className="header-fixed border-bottom border-color">
          ...
          >
            ...
            >
              <img width="150px" src="https://st3.depositphotos.com/4035913/15099/v/450/depositphotos_150990286-stock-illustration-lh-l-h-black-letter.jpg" height="100px" style={{width: "80%"}} alt="" />
            </NavLink>
